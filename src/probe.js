...
const PROBE_KEYWORDS = [
  // 디저트 세부
  '쿠키맛집', '수제쿠키', '크림빵맛집', '타르트맛집', '파이맛집',
  '마카롱맛집', '케이크맛집', '젤라또', '빙수맛집', '와플맛집',
  '도넛맛집', '슈크림', '카스테라', '푸딩', '티라미수',
  '찹쌀떡', '모찌', '양갱', '만주', '호두과자',
  // 음식 카테고리
  '오마카세', '스시오마카세', '고기오마카세', '중식맛집', '일식맛집',
  '이탈리안맛집', '프렌치맛집', '태국음식', '베트남쌀국수', '멕시칸',
  '샤브샤브', '숯불구이', '곱창맛집', '냉면맛집', '국수맛집',
  // 음료
  '말차라떼', '우베라떼', '딸기라떼', '흑임자라떼', '밀크티맛집',
  '스무디', '에이드', '콤부차', '수제청', '과일주스',
  // 지역 핫플
  '성수맛집', '연남맛집', '을지로맛집', '광화문맛집', '종로맛집',
  '압구정맛집', '한남맛집', '망원맛집', '이태원맛집', '서촌맛집',
  '잠실맛집', '여의도맛집', '강남맛집', '홍대맛집', '합정맛집',
  // 트렌드 시그널
  '줄서는맛집', '오픈런맛집', '웨이팅맛집', '예약필수맛집',
  '신상카페', '신상맛집', '팝업맛집', '팝업카페', '팝업스토어',
  // 특정 매장/브랜드 탐침 (여기 추가하면 검색량 모니터링)
  '설이동', '보카도버터', '누다케', '노티드', '올드페리도넛',
  '아우어베이커리', '폴바셋', '런던베이글뮤지엄', '카멜커피',
];
