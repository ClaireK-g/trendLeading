// 텔레그램 전송 유틸 — src/alerter.js·buzz/lib/telegram.js와 완전 독립 구현(hot10 모듈 격리 원칙).
...
export async function sendTelegram(message) {
  ...
  if (!botToken || !chatId) {
    throw new Error('TELEGRAM_BOT_TOKEN 또는 챗 ID(HOT10_TELEGRAM_CHAT_ID/TELEGRAM_CHAT_ID) 미설정');
  }
